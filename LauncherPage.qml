        ...
        delegate: Component {
            ...
            Item {
                ...
                Timer {
                    ...
                    running: preview.status == Loader.Ready && (activeLauncher == index || preview.item.currentIndex > 0)
                    repeat: true
                    onTriggered: {
                        if (preview.item.currentIndex == 0) {
                            preview.item.currentIndex = preview.item.count - 1;
                            activeLauncher ++;
                            if (activeLauncher == folderModel.count) {
                                activeLauncher = 0;
                            }
                        }
                    }
